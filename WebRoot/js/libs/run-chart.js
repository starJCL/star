...
/*
 * Single Two Bar Graphic 14-FavouritePage-Statistics.html
 */
if (twoBarChart !== null) {
...
/*
 * Lines Graphic 14-FavouritePage-Statistics.html
 */
...
/*
 * Monthly Bar Graphic 26-Statistics.html
 */
	...
	var oneBarEl = new Chart(ctx_ob, {
		...
		options : {
			deferred : { // enabled by default
				delay : 200
			// delay of 500 ms after the canvas is
...
/*
 * Waves Graphic 26-Statistics.html
 */
...
/*
 * Pie Chart with Text 26-Statistics.html
 * 
			...
			current_cart.circleProgress({
				...
				fill : {
					...
					function(event, progress) {
						current_cart.find('.content').html(
...
/*
 * Worldwide Statistics 26-Statistics.html
 * 
...
if (USMapChart !== null) {
	...
	function drawUSRegionsMap() {
		...
		var data = google.visualization.arrayToDataTable([
				...
				[ 'Los Angeles', 135241, 18421 ], [ 'Chicago', 9595, 1217 ],
				[ 'Austin', 9063, 13360 ], [ 'Washington', 276147, 12855 ],
...
/*
 * Yearly Line Graphic 26-Statistics.html
 */
if (lineChart !== null) {
		...
		datasets : [
				{
					...
					fill : false,
					lineTension : 0,
					data : [ 96, 63, 136, 78, 111, 83, 101, 83, 102, 61, 45,
							135 ]
				},
				{
					label : " - Likes",
					...
					fill : false,
					lineTension : 0,
					data : [ 118, 142, 119, 123, 165, 139, 145, 116, 152, 123,
							139, 195 ]
				} ]
	};
...
/*
 * Radar Chart 26-Statistics.html
 */
